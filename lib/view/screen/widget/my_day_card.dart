...
class MyDayCard extends StatelessWidget {
  final AlubmModel album;
  final PhotoModel photo;
  bool showCircleAvartor;
  MyDayCard({super.key,this.showCircleAvartor=true,required this.photo,required this.album});
  ...
  imageBuilder: (context, imageProvider) => Container(
      ...
      child: Column(
        mainAxisAlignment:showCircleAvartor? MainAxisAlignment.spaceBetween:MainAxisAlignment.end,
        ...
        children: [
          ...
          Text(photo.user.name.toString(),style: TextStyle(
            color: Colors.white,
            fontSize: 14,
